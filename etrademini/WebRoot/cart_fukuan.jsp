...
<table width="966" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<br><br>
	<strong><font size="6" color="red">是否马上去付款?</font></strong>	<div align="center"><br>
              <%if(session.getAttribute("cart")==null){%>
           <form name="form" method="post" action="catr_bank.jsp">
           <input type="submit" name="Submit2" value="确定">&nbsp;
               <input type="reset" name="reset" value="再逛逛">&nbsp;
               </form>
           <%}else{%>
