...
<!--左侧01-->
	...
	<table width="100%" height="138"  border="0" cellpadding="0" cellspacing="0" background="image/fg_left01.jpg">
      <tr>
        ...
        <form name="form" method="post" action="memberAction.do?action=1" onSubmit="checkEmpty(form)">
          <table width="185" border="0" align="center">
            <tr><br></tr>>
            <tr>
              <td width="60" height="25" style="color:white;">用户名：</td>
              <td width="115"> <input name="name" type="text" size="17"></td>
            </tr>
            <tr>
              <td height="25" style="color:white;">密&nbsp;&nbsp;码：</td>
              <td><input name="password" type="password" size="17"></td>
            </tr>
			 <tr>
              <td height="26"><input type="submit"  value="登录" /></td>
              <td height="26">  &nbsp;&nbsp;<a href="fg-memberRegister.jsp" style="color:white;">注册</a>&nbsp;&nbsp;<a href="fg-One.jsp" style="color:white;">找回密码？</a></td>
			 </tr>	  
          </table>
		  </form>
		  </td>
        ...
        <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
		 <tr>
          ...
          <table width="167" border="0" align="center">
            <tr>
              <td width="161" height="25" style="color:white;"><font color="#FB6801"><%=form.getName()%>,</font>欢迎回来</td>
              </tr>
            <tr>
              <td height="25" style="color:white;"><%=countTime.currentlyTime()%></td>
              </tr> 
			  <tr>
              <td height="20" align="right" valign="middle" style="color:white;"><a href="javascript:quit()">安全退出</a></td>
              </tr>	
          </table>
	  </td>
     </tr>
          ...
          <tr>
            <td valign="top"><table width="150" border="0">
              ...
              <table width="179" border="0" align="center">
                <tr>
                  <td width="171" height="143" style="color:white;">
             ...
             onmouseover="this.stop()" scrollAmount="1" scrollDelay="1" >	  
		            <%
                      for(int i=0;i<afficheList.size();i++){
                        ...
                        %>
						<img src="image/sign.gif">&nbsp;<a style="color:white;" href="#" onClick="window.open('fg-afficheSelect.jsp?id=<%=afficheForm.getId()%>','','width=500,height=400');"><%=afficheForm.getName()%></a><br><br>
						<%}%>
            </marquee>			      </td>
                </tr>
              </table></td>
           ...
           if(number>7){
             ...
             %>			
			  <table width="178" height="19" border="0" align="center" cellpadding="0" cellspacing="0" background="image/fg_left04.jpg">
			    <tr>
			    <td width="14"></td>
                <td width="164" ><a style="color:white;" href="bg-sellResult.jsp?id=<%=form.getId()%>&account=<%=account+1%>"><%=account+1%>&nbsp;&nbsp;<%=form.getName()%></a></td>
				</tr>   
            </table>				
			<%}%>	</td>
          </tr>
            ...
            <td valign="top"><table width="173">
             ...
             onmouseover="this.stop()" scrollAmount="1" scrollDelay="1">	  
		            <%
                      ...
                      %>
					<img src="image/sign1.gif">&nbsp; <a style="color:white;" href="<%=linkForm.getLinkAddress()%>" target="_blank"><%=linkForm.getLinkName()%></a><br><br>
					<%}%>
            </marquee>				 </td>
                </tr>
              </table></td>
