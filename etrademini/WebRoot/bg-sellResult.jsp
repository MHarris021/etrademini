...
<table width="966" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="759" valign="top" bgcolor="#FFFFFF" align="center">
    <!--右侧01-->	
	...
	<br><br><br>
		<table width="60%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
          <tr>
            <td   rowspan="5" height="126"><div align="center">
                <img src="<%=form.getPriture()%>" width="140" height="126" alt="" />
            </div></td>
            <td width="70%" height="30"><div align="center"><%=form.getName()%></div></td>
          </tr>
